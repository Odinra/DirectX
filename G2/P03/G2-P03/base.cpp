...
D3DLIGHT9 d3d::InitDirectionalLight(D3DXVECTOR3* direction, D3DXCOLOR* color, D3DXVECTOR3* position)
{
	D3DLIGHT9 light;
...
D3DLIGHT9 d3d::InitPointLight(D3DXCOLOR* color, D3DXVECTOR3* position)
{
	D3DLIGHT9 light;
	::ZeroMemory(&light, sizeof(light));
	light.Type = D3DLIGHT_POINT;
	//light.Ambient = *color * .5f;
	light.Diffuse = *color;
	//light.Specular = *color * .5f;	
	//light.Direction = *direction;
	light.Position = *position;
	light.Range = 100;    // a range of 100
