...
namespace d3d
{
	...
	const D3DXCOLOR  LIGHTBLUE( D3DCOLOR_XRGB( 51, 153, 255) );
	const D3DXCOLOR    BUGREEN( D3DCOLOR_XRGB( 0 ,  48,  21) );
	const D3DXCOLOR     BUGOLD( D3DCOLOR_XRGB(255, 188,  25) );
	...
	const D3DMATERIAL9 BUGREEN_MTRL	= InitMtrl(BUGREEN	, BUGREEN, BUGREEN, BUGREEN, 4.0f);
	const D3DMATERIAL9 BUGOLD_MTRL	= InitMtrl(BUGOLD	, BUGOLD, BUGOLD, BUGOLD, 4.0f);
	const D3DMATERIAL9 GRAY_MTRL	= InitMtrl(GRAY		, GRAY, GRAY, GRAY, 2.0f);

	D3DLIGHT9 InitDirectionalLight(D3DXVECTOR3* direction, D3DXCOLOR* color, D3DXVECTOR3* position);
