/*WinMain, WinProc(most likely to be here rather than base.cpp), Function calls to base functions,
Sound/Physics/AI/Multi-User/Input/Logic/Frame render/Sync (or can all be in main.cpp depending on size)*/
#include "base.h"
#include <stdio.h>
#include <string>
using namespace std;
...
//declare variables
double dDegToRadResult, dRadToDegResult, dDegRad, dSideA, dSideB, dSideC,
...
//Builds the window and then enters the main loop
