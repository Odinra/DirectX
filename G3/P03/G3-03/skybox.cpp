...
TTexVertex g_SkyboxMesh[20] =
{
	// Front quad, NOTE: All quads face inward
	{-1000.0f, -0010.0f,  1000.0f,  0.0f, 1.0f },
	{-1000.0f,  1990.0f,  1000.0f,  0.0f, 0.0f },
	{ 1000.0f, -0010.0f,  1000.0f,  1.0f, 1.0f },
	{ 1000.0f,  1990.0f,  1000.0f,  1.0f, 0.0f },
	...
	// Top quad
	{-1000.0f,  1990.0f,  1000.0f,  0.0f, 1.0f },
	{-1000.0f,  1990.0f, -1000.0f,  0.0f, 0.0f },
	{ 1000.0f,  1990.0f,  1000.0f,  1.0f, 1.0f },
	{ 1000.0f,  1990.0f, -1000.0f,  1.0f, 0.0f },
	
	// //Bottom quad
	//{-1000.0f, -0010.0f, -1000.0f,  0.0f, 1.0f },
	//{-1000.0f, -0010.0f,  1000.0f,  0.0f, 0.0f },
	//{ 1000.0f, -0010.0f, -1000.0f,  1.0f, 1.0f },
	//{ 1000.0f, -0010.0f,  1000.0f,  1.0f, 0.0f }
};
...
bool BuildSkybox(IDirect3DDevice9* Device)
{
    ...
    hRet = D3DXCreateTextureFromFile( Device, ("Down.jpg"), &g_SkyTextures[5] );
    if ( FAILED(hRet) )
		return false;
